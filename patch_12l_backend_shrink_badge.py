...
old_1 = "const badgeWidth = Math.max(40, Math.round(w * 0.22));"
new_1 = "const badgeWidth = Math.max(40, Math.round(w * 0.13));"
content = replace_once("applyAiBadge: mniejszy rozmiar (0.22 -> 0.13)", old_1, new_1, content)
